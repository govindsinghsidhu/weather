...
public class ApplicationExceptionHandler extends ResponseEntityExceptionHandler{
	...
	{	LOGGER.error(ApplicationConstants.ERROR_CODE+e.getErrorCode()+ApplicationConstants.ERROR_MESSAGE +e.getErrorMessage());
	...
	{	
		LOGGER.error(ApplicationConstants.ERROR_CODE+RestErrorCode.BAD_REQUEST.getErrorCode()+ApplicationConstants.ERROR_MESSAGE +RestErrorCode.BAD_REQUEST.getErrorMessage());
	...
	{	LOGGER.error(ApplicationConstants.ERROR_CODE+RestErrorCode.METHOD_NOT_SUPPORTED.getErrorCode()+ApplicationConstants.ERROR_MESSAGE +RestErrorCode.METHOD_NOT_SUPPORTED.getErrorMessage());
	...
	{	
		LOGGER.error(ApplicationConstants.ERROR_CODE+RestErrorCode.CONTENT_TYPE_NOT_SUPPORTED.getErrorCode()+ApplicationConstants.ERROR_MESSAGE +RestErrorCode.CONTENT_TYPE_NOT_SUPPORTED.getErrorMessage());
	...
	{	RestError restError = new RestError(RestErrorCode.INTERNAL_SERVER_ERROR.getErrorCode(),RestErrorCode.INTERNAL_SERVER_ERROR.getErrorMessage(),HttpStatus.INTERNAL_SERVER_ERROR.value(),LocalDateTime.now());
	    ...
	    if(e.getMessage().contains(ApplicationConstants.NOT_CONTENT))
	    	restError = new RestError(RestErrorCode.NO_CITY_FOUND.getErrorCode() , RestErrorCode.NO_CITY_FOUND.getErrorMessage(),HttpStatus.CONFLICT.value(),LocalDateTime.now());
		if(e.getMessage().equals(ApplicationConstants.ACCESS_DENIED))
		 restError = new RestError(RestErrorCode.ACCESS_DENIED.getErrorCode() , RestErrorCode.ACCESS_DENIED.getErrorMessage(),HttpStatus.FORBIDDEN.value(),LocalDateTime.now());
	...
	{	LOGGER.error(ApplicationConstants.ERROR_CODE+RestErrorCode.INTERNAL_SERVER_ERROR.getErrorCode()+ApplicationConstants.ERROR_MESSAGE +RestErrorCode.INTERNAL_SERVER_ERROR.getErrorMessage());
		RestError restError = new RestError(RestErrorCode.INTERNAL_SERVER_ERROR.getErrorCode(),RestErrorCode.INTERNAL_SERVER_ERROR.getErrorMessage(),HttpStatus.INTERNAL_SERVER_ERROR.value(),LocalDateTime.now());
